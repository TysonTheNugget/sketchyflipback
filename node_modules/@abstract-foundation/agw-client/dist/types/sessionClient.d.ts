import { type Account, type Address, type Client, type NonceManager, type Transport } from 'viem';
...
type GetNonceManagerParameter<account extends Account | Address = Address> = account extends Account ? {
    nonceManager?: never;
} : {
    nonceManager?: NonceManager;
};
type CreateSessionClientParameters<account extends Account | Address = Address> = {
    account: account;
    chain: ChainEIP712;
    signer: Account;
 ...
 */
export declare function createSessionClient<account extends Account | Address = Address>({ account, signer, chain, transport, session, paymasterHandler, nonceManager, }: CreateSessionClientParameters<account>): SessionClient;
export {};

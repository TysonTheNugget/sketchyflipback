import { type Account, type Address, type Client, type Hex, type PublicClient, type Transport, type WalletClient } from 'viem';
import { type ChainEIP712, type SignEip712TransactionReturnType } from 'viem/zksync';
 ...
 */
export declare function signTransactionBatch<chain extends ChainEIP712 | undefined = ChainEIP712 | undefined, account extends Account | undefined = Account | undefined, chainOverride extends ChainEIP712 | undefined = ChainEIP712 | undefined>(client: Client<Transport, ChainEIP712, Account>, signerClient: WalletClient<Transport, ChainEIP712, Account>, publicClient: PublicClient<Transport, ChainEIP712>, parameters: SignTransactionBatchParameters<chain, account, chainOverride>, validator: Address, validationHookData?: Record<string, Hex>, customPaymasterHandler?: CustomPaymasterHandler | undefined, isPrivyCrossApp?: boolean): Promise<SignEip712TransactionReturnType>;
//# sourceMappingURL=signTransactionBatch.d.ts.map
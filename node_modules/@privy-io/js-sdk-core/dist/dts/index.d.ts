 ...
 */
declare const isEmbeddedWalletAccount: (account: PrivyLinkedAccount) => account is PrivyEmbeddedWalletAccount;
 ...
 */
declare function create(context: WalletApiActionContext, { request }: Input$3): Promise<WalletResponseType>;

type Input$2 = WalletApiRpcInputType & {
    wallet_id: string;
};
/**
 ...
 */
declare function rpc(context: WalletApiActionContext, sign: SignWalletRequest, { wallet_id, ...request }: Input$2): Promise<WalletApiRpcResponseType>;

type Input$1 = WalletApiRawSignInputType & {
    wallet_id: string;
};
/**
 ...
 */
declare function rawSign(context: WalletApiActionContext, sign: SignWalletRequest, { wallet_id, ...request }: Input$1): Promise<WalletApiRawSignResponseType>;
